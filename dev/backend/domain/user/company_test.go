...
func TestNewCompanyValid(t *testing.T) {
	...
	assert.Equal(t, fantasyName, company.FantasyName.Get(), "Fantasy name mismatch")
	assert.Equal(t, legalName, company.LegalName.Get(), "Legal name mismatch")
}
...
func TestNewCompanyInvalidFantasyName(t *testing.T) {
	...
	_, err := user.NewCompany(cnpj, email, fantasyName, legalName, phones, addresses, contactNames)
	assert.ErrorIs(t, err, fields.ErrInvalidName, "Expected invalid fantasy name")
}
...
func TestNewCompanyInvalidLegalName(t *testing.T) {
	...
	_, err := user.NewCompany(cnpj, email, fantasyName, legalName, phones, addresses, contactNames)
	assert.ErrorIs(t, err, fields.ErrInvalidName, "Expected invalid legal name")
}
